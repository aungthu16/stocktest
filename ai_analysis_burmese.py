...
st.write("ဤစာမျက်နှာရှိ အချက်အလက်များသည် ပညာရေးဆိုင်ရာ ရည်ရွယ်ချက်များအတွက်သာ ဖြစ်ပြီး၊ ရင်းနှီးမြှုပ်နှံမှုဆိုင်ရာ အကြံပြုချက် သို့မဟုတ် မည်သည့်ရှယ်ယာကိုမဆို ဝယ်ယူရန်/ရောင်းချရန် အကြံပြုခြင်းမဟုတ်ပါ။")
